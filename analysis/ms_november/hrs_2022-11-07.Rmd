...
setwd("G:/Shared drives/FES_Data_Sharing_Forestry/Manuscripts/histressupp/analysis/ms_november")
...
historical cost-availability curves for collecting and delivering
...
*et al.* @Yemshanov2014. They develop cost-availability curves at national and
...
We use the province of Alberta, Canada as our study area. It
...
(ERA). **will cite when location is finalized** Notice that the supply areas include areas outside the
...
for a plant capacity of 150 Gg·yr^-1^ @Sultana2010. Given how
