...
@NFIS2021a.  It is used to calculate stem wood, stem bark, branch, and
...
ggsave("../img/harv_comparison.tiff", plot = harv_comparison, device='tiff', dpi=300)
...
ggsave("../img/cyclePlot.tiff", plot = cyclePlot, device='tiff', dpi=300)
...
ggsave("../img/mcPlot.tiff", plot = mcPlot, device='tiff', dpi=300)
...
ggsave("../img/bPlot.tiff", plot = bPlot, device='tiff', dpi=300)
...
#ggsave("../img/avePlot.tiff", plot = avePlot, width = 6, height = 4, units = "in", device='tiff', dpi=300)
ggsave("../img/avePlot.tiff", plot = avePlot, device='tiff', dpi=300)
