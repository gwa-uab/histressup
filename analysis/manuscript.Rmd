...
different plant capacities: 200 Tg/a  corresponding to a small wood pellet
mill, 400 Tg/a  corresponding to a large pellet mill or a small ethanol
plant, and 800 Tg/a  corresponding to a large ethanol plant.
...
ave <- aveave %>%
  ...
  cols_label(location = "Location",
             capacity = "Capacity (Tg/a)",
             aveavecost = "Mean ($·Mg^-1^)", 
             sdavecost = "Std. Dev. ($·Mg^-1^)", 
             cv = "C.V.")
```

Figures 9 and 10 display marginal cycle time (h) and marginal costs ($·Mg^-1^)
for each of the 16 years in the study period, and for the 3 alternative plant 
...
become clearer at a capacity of 800 Tg, where Whitecourt is the low cost location
for most of the years.


Table ?? presents summary statistics over the 16 year for the locations and 
...
in low timber harvest years, particularly for the 800 Tg/a capacity.  Similar
maps could be produced for the other locations and all 16 years, but that is
unecessary here.
