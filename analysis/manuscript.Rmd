...
- Alex McPhee^[Department of Resource Economics and Environmental Sociology, University
  of Alberta]
- Dennis Gray^[Department of Resource Economics and Environmental Sociology, University
  of Alberta]
...
and presents the main results based on our placeholder costs.  Author priority right now is alphabetical
based on our first names, or reverse alphabetical based on our last names.  This will likely change
...
** A nice picture demonstrating dendritic nature of road network ** 
  ...
  * road network "rasterized" **how ?**
  
## service areas
  
  * median haul time calculated for each township
  
  
```{r haul, echo=FALSE, fig.cap="one way haul times from edson", out.width = '100%'}
knitr::include_graphics("../img/haultime.png")
```
